...
<head>
  ...
  <title>Mavic - Carrrito de Compras</title>
</head>
<body>
      ...
      <div class="row">
        <div class="col-12 breadcrumb text-muted">
          ...
          foreach($datos as $d){
            ...
            $res = $conn->query($sql);
            while($f = $res->fetch_assoc()){$idcolor1=$f['COLOR1'];$idcolor2=$f['COLOR2'];$idmodelo=$f['IDMODELO'];}
            $sql="SELECT COLOR FROM COLOR WHERE IDCOLOR=$idcolor1";
            $res = $conn->query($sql);
            while($f = $res->fetch_assoc()){$color1=$f['COLOR'];}
            $sql="SELECT COLOR FROM COLOR WHERE IDCOLOR=$idcolor2";
            $res = $conn->query($sql);
            while($f = $res->fetch_assoc()){$color2=$f['COLOR'];}
            ?>
            <div class="container">
                            ...
                            <form class="" action="carrito.php" method="POST" onsubmit="return validacion()">
                              <div class="row">
                                ...
                                <div class="col-2 offset-3">
                                  ...
                                  $res= $conn->query($sql);
                                  if ($res->num_rows > 0){while($f=$res->fetch_assoc()){$max=$f['CANTIDAD'];}}
                                  ?>
