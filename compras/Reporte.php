...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es">
  ...
  <body>
   ...
   <div class="container mt-4">
    ...
    <p class="lead">Inserta tu <a href="../faq/index.php?id=5" target="_blank">llave digital</a> de compra en el campo que se muestra abajo junto con tu cedula y los datos de pago. Y podrás Reportar el pago de tu compra. <b>Recuerda realizar el pago por el monto exacto de la compra.</b></p>
    <hr class="my-4">
  </div>
